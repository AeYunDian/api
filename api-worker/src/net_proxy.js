...
export function getProxyAuthPage(tips = null, redirectUrl = null) {
    return `<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
document.getElementById('loginBtn').onclick=function(){
  ...
  window.location.href='/proxy/v1/auth?key='+encodeURIComponent(key) ${redirectUrl ? `+ '&redirect-to=' + "${redirectUrl}"` : ''} + '&_t=' + (new Date().getTime());
};
</script>
</body></html>`;
}