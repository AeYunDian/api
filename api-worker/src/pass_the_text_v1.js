import { isBase64, utf8ToBase64, base64ToUtf8 } from "./utils.js";
const PASS_TEXT_TBL_MESSAGES = 'pass_text_messages';
export default {
  async handleSaveText(request, env) {
    // 处理保存文本的请求
    // 从请求中获取文本内容和相关信息
  ...
  async handleDeleteText(request, env) {
  ...
  async initDatabase(request, env) {
