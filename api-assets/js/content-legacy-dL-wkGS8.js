(function(){function e(e){return r(e)||n(e)||o(e)||t()}function t(){throw TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function n(e){if(typeof Symbol<`u`&&e[Symbol.iterator]!=null||e[`@@iterator`]!=null)return Array.from(e)}function r(e){if(Array.isArray(e))return s(e)}function i(e,t){return l(e)||c(e,t)||o(e,t)||a()}function a(){throw TypeError(`Invalid attempt to destructure non-iterable instance.
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var a,o=!0,s=!1;return{s:function(){n=n.call(e)},n:function(){var e=n.next();return o=e.done,e},e:function(e){s=!0,a=e},f:function(){try{o||n.return==null||n.return()}finally{if(s)throw a}}}}function d(e,t){if(e){if(typeof e==`string`)return f(e,t);var n={}.toString.call(e).slice(8,-1);return n===`Object`&&e.constructor&&(n=e.constructor.name),n===`Map`||n===`Set`?Array.from(e):n===`Arguments`||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?f(e,t):void 0}}function f(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=Array(t);n<t;n++)r[n]=e[n];return r}System.register([`./preload-helper-legacy-mRVs4gLv.js`],function(t,n){var r,a,o,s,c,l,d,f;function p(e){var t=/^---\r?\n([\s\S]*?)\r?\n---\r?\n?([\s\S]*)$/.exec(e);if(!t)return{data:{},body:e};var n=t[1].split(/\r?\n/),r={},i=null,a=null,o=u(n),s;try{for(o.s();!(s=o.n()).done;){var c=s.value,l=/^\s*-\s+(.*)$/.exec(c);if(l&&i){a||(a=[],r[i]=a),a.push(l[1].trim().replace(/^["']|["']$/g,``));continue}var d=/^([a-zA-Z][\w-]*)\s*:\s*(.*)$/.exec(c);if(d){var f=d[1],p=d[2].trim();i=f,a=null,p===``?(r[f]=[],a=r[f]):r[f]=p.startsWith(`[`)&&p.endsWith(`]`)?p.slice(1,-1).split(`,`).map(function(e){return e.trim().replace(/^["']|["']$/g,``)}).filter(Boolean):p===`true`||p===`false`?p===`true`:p.replace(/^["']|["']$/g,``)}}}catch(e){o.e(e)}finally{o.f()}return{data:r,body:t[2]}}function m(e){return e.replace(/<script[\s\S]*?<\/script>/gi,``).replace(/<style[\s\S]*?<\/style>/gi,``).replace(/<\/?[A-Z][\w-]*(\s[^>]*)?>/g,``).replace(/<!--[\s\S]*?-->/g,``).replace(/[#>*`\[\]()\-!\n\r]/g,` `).replace(/\s+/g,` `).trim()}function h(e,t){var n,r,i,a,o,s=e.replace(`./posts/`,``).replace(/\.md$/,``),c=p(t),u=c.data,d=c.body;if(u.draft===!0)return null;var f=/^#\s+(.+)$/m.exec(d),h=f?f[1].trim():s,g=(n=(r=u.category)==null?u.categories:r)==null?`未分类`:n,_=Array.isArray(g)?g[0]:g,v=(i=(a=u.tags)==null?u.tag:a)==null?[]:i,y=Array.isArray(v)?v:[v],b=(o=/\.(\d{4}-\d{2}-\d{2})\.md$/.exec(e))==null?void 0:o[1],x=u.date?String(u.date).slice(0,10):b||`1970-01-01`,S=m(d);return{slug:s,title:u.title||h,date:x,category:_,tags:y,listed:u.listed!==!1,summary:u.summary||S.slice(0,100),featured:!!u.featured,readingMinutes:Math.max(1,Math.round(S.length/350)),searchText:S.toLowerCase(),component:l[e]}}function g(e){return d.find(function(t){return t.slug===e})}function _(e){return f.filter(function(t){return t.category===e})}function v(e){return f.filter(function(t){return t.tags.includes(e)})}function y(){return f.filter(function(e){return e.featured})}function b(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:6;return f.slice(0,e)}function x(){var e={},t=u(f),n;try{for(t.s();!(n=t.n()).done;){var r,i=n.value,a=i.date.slice(0,4);((r=e[a])==null?e[a]=[]:r).push(i)}}catch(e){t.e(e)}finally{t.f()}return Object.entries(e).sort(function(e,t){return t[0].localeCompare(e[0])})}function S(e){var t=String(e||``).trim().toLowerCase();return t?f.filter(function(e){return e.title.toLowerCase().includes(t)||e.summary.toLowerCase().includes(t)||e.category.toLowerCase().includes(t)||e.tags.some(function(e){return e.toLowerCase().includes(t)})||e.searchText.includes(t)}):[]}return t({a:_,i:g,l:S,n:x,o:v,r:y,s:b}),{setters:[function(e){r=e.t}],execute:function(){a=`---
...
`,c=Object.assign({"./posts/markdown-vue-usage-2026-09-18.md":a,"./posts/site-design-compliance-2026-09-16.md":o,"./posts/welcome-2026-09-13.md":s}),l=Object.assign({"./posts/markdown-vue-usage-2026-09-18.md":function(){return r(function(){return n.import(`./markdown-vue-usage-2026-09-18-legacy-DVnvZgoh.js`)},void 0)},"./posts/site-design-compliance-2026-09-16.md":function(){return r(function(){return n.import(`./site-design-compliance-2026-09-16-legacy-kxSu9t0e.js`)},void 0)},"./posts/welcome-2026-09-13.md":function(){return r(function(){return n.import(`./welcome-2026-09-13-legacy-BzQa1mM5.js`)},void 0)}}),d=Object.entries(c).map(function(e){var t=i(e,2),n=t[0],r=t[1];return h(n,r)}).filter(Boolean).sort(function(e,t){return t.date.localeCompare(e.date)}),t(`c`,f=d.filter(function(e){return e.listed})),t(`t`,e(new Set(f.map(function(e){return e.category}))).filter(Boolean).sort()),t(`u`,e(new Set(f.flatMap(function(e){return e.tags}))).filter(Boolean).sort())}}})})();