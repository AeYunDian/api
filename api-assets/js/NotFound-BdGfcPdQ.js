import{K as e,P as t,T as n,_ as r,a as i,c as a,d as o,g as s,h as c,i as l,j as u,tt as d}from"./runtime-core.esm-bundler-CZToptw-.js";import{t as f}from"./runtime-dom.esm-bundler-CZT_pOmh.js";/* empty css               */import{A as p,B as m,J as h,K as g,V as _,Y as v,bt as y,ct as b,j as x,k as S,tt as C}from"./es-5umfOsy8.js";import{t as w}from"./chip-BzLVD9l8.js";import{t as T}from"./_plugin-vue_export-helper-BDNMzG2s.js";import"./style-CY6_zH40.js";var E={show:Boolean,lockScroll:{type:Boolean,default:!0},teleport:[String,Object,Boolean],closeOnKeyEscape:{type:Boolean,default:!0},onClick:_(),onKeyEscape:_(),"onUpdate:show":_()},{name:D,n:O}=m(`overlay`),k=r({name:D,inheritAttrs:!1,props:E,setup(e,{slots:t,attrs:r}){let{zIndex:a}=S(()=>e.show,3),{onStackTop:o}=p(()=>e.show,a),{disabled:c}=g();x(()=>e.show,()=>e.lockScroll),C(()=>window,`keydown`,l);function l(t){!o()||t.key!==`Escape`||!e.show||(b(e.onKeyEscape),e.closeOnKeyEscape&&(y(t),b(e[`onUpdate:show`],!1)))}function u(){b(e.onClick),b(e[`onUpdate:show`],!1)}function d(){return s(`div`,n({class:O(),style:{zIndex:a.value-2}},r),[s(`div`,{class:O(`overlay`),style:{zIndex:a.value-1},onClick:u},null),s(`div`,{class:O(`content`),style:{zIndex:a.value}},[b(t.default)])])}function m(){return s(f,{name:O(`--fade`)},{default:()=>[e.show&&d()]})}return()=>{let{teleport:t}=e;return t?s(i,{to:t,disabled:c.value},{default:()=>[m()]}):m()}}});h(k),v(k,E);var A=k,j={class:`coming-soon`},M={class:`coming-soon__content`},N={class:`coming-soon__features`},P=T({__name:`NotFound`,setup(n){let r=d(!0);return u(()=>{window.addEventListener(`click`,()=>{r.value=!1}),(()=>{let e=document.getElementById(`__ai-chat-overlay`);e&&e.remove();let t=document.getElementById(`__ai-chat-ball`);t&&t.remove(),document.querySelectorAll(`style[data-aichat]`).forEach(e=>e.remove());let n=document.createElement(`style`);n.setAttribute(`data-aichat`,``),n.textContent=`
