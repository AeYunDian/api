import{E as e,F as t,K as n,M as r,a as i,c as a,d as o,g as s,h as c,i as l,tt as u,v as d}from"./runtime-core.esm-bundler-DTqHLZ9O.js";import{d as f}from"./index-BVHGVbJR.js";/* empty css               */import{B as p,D as m,E as h,M as g,N as _,R as v,T as y,V as b,et as x,ft as S,q as C}from"./es-CopK9xoX.js";import{t as w}from"./chip-ClVDnW2g.js";import{t as T}from"./_plugin-vue_export-helper-BDNMzG2s.js";import"./style-CLqUTge4.js";var E={show:Boolean,lockScroll:{type:Boolean,default:!0},teleport:[String,Object,Boolean],closeOnKeyEscape:{type:Boolean,default:!0},onClick:_(),onKeyEscape:_(),"onUpdate:show":_()},{name:D,n:O}=g(`overlay`),k=d({name:D,inheritAttrs:!1,props:E,setup(t,{slots:n,attrs:r}){let{zIndex:a}=y(()=>t.show,3),{onStackTop:o}=h(()=>t.show,a),{disabled:c}=v();m(()=>t.show,()=>t.lockScroll),C(()=>window,`keydown`,l);function l(e){!o()||e.key!==`Escape`||!t.show||(x(t.onKeyEscape),t.closeOnKeyEscape&&(S(e),x(t[`onUpdate:show`],!1)))}function u(){x(t.onClick),x(t[`onUpdate:show`],!1)}function d(){return s(`div`,e({class:O(),style:{zIndex:a.value-2}},r),[s(`div`,{class:O(`overlay`),style:{zIndex:a.value-1},onClick:u},null),s(`div`,{class:O(`content`),style:{zIndex:a.value}},[x(n.default)])])}function p(){return s(f,{name:O(`--fade`)},{default:()=>[t.show&&d()]})}return()=>{let{teleport:e}=t;return e?s(i,{to:e,disabled:c.value},{default:()=>[p()]}):p()}}});p(k),b(k,E);var A=k,j={class:`coming-soon`},M={class:`coming-soon__content`},N={class:`coming-soon__features`},P=T({__name:`NotFound`,setup(e){let i=u(!0);return r(()=>{window.addEventListener(`click`,()=>{i.value=!1}),(()=>{let e=document.getElementById(`__ai-chat-overlay`);e&&e.remove();let t=document.getElementById(`__ai-chat-ball`);t&&t.remove(),document.querySelectorAll(`style[data-aichat]`).forEach(e=>e.remove());let n=document.createElement(`style`);n.setAttribute(`data-aichat`,``),n.textContent=`
