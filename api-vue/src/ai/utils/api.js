// src/utils/api.js
const BASE_URL = import.meta.env.VITE_ONLINE_API_BASE_URL || 'https://online.undz.cn';
const SDK_VERSION = import.meta.env.VITE_ONLINE_APP_SDK_VER || '0';
const APP_ID = import.meta.env.VITE_ONLINE_APP_ID;
